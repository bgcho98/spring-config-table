...
public class SctTableEditorDialog extends DialogWrapper {
    ...
    private final SctSimpleTableEditor editor;
    ...
    @Override protected @Nullable JComponent createCenterPanel() { return editor.getComponent(); }
    @Override protected Action @NotNull [] createActions() { return new Action[]{getOKAction()}; }
    @Override protected void dispose() { editor.dispose(); super.dispose(); }
}
